...
from .multimodal_encoder.vision_tokenizer import VisionTokenizer, VisionCompressor
...
class EVEMetaForCausalLM(ABC):
    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        return None, attention_mask, past_key_values, new_input_embeds, new_labels, patch_hw
