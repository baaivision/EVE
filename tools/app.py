...
from eve.mm_utils import (KeywordsStoppingCriteria, load_image_from_base64,
...
[[Project Page](https://eve.github.io/)] [[Code](https://github.com/baaivision/EVE)] | 📚 [[Paper](https://arxiv.org/abs/2406.11832)]
""")
tos_markdown = ("""
### Terms of use
...
def build_demo():
    ...
    with gr.Blocks(title="EVE-7B-HD-v1.0", theme=gr.themes.Default(), css=block_css) as demo:
        state = gr.State()
        ...
        with gr.Row():
            with gr.Column(scale=5):
                with gr.Row(elem_id="Model ID"):
                    gr.Dropdown(
                        choices=['EVE-7B-HD-v1.0'],
                        value='EVE-7B-HD-v1.0',
                        interactive=True,
                        label='Model ID',
                        container=False)
            ...
            with gr.Column(scale=8):
                chatbot = gr.Chatbot(
                    elem_id="chatbot", label="EVE-7B-HD-v1.0 Chatbot", height=550)
                with gr.Row():
                    with gr.Column(scale=8):
                        textbox.render()
...
def parse_args():
    ...
    parser.add_argument("--model-path", type=str,
                        default="BAAI/EVE-7B-HD-v1.0")
    parser.add_argument("--model-name", type=str,
                        default="EVE-7B-HD-v1.0")
