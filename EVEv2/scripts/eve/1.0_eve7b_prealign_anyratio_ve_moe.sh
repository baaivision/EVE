...
export DATA_PATH=playground/data/EVE-v2.0-Pretrain/json_path/datacomp1b-30m-index.json
...
export BASE_LR=1e-4
export LEARNIG_RATE=1e-4

export CKPT_PATH=checkpoints/EVEv2-stage0-rep
export SAVE_PATH=EVEv2-stage1.0
